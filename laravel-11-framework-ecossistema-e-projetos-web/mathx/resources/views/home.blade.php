...
<body>
    ...
    <form action="{{ route('generate_exercises') }}" method="post">
        @csrf
        ...
        <div class="container">
            <div class="row">
                <div class="div alert alert-danger text-center mt-3">
                    Por favor, selecione ao menos uma informação. As parcelas devem ser números entre 0 e 999. O número
                    de exercícios deve variar entre 5 e 50.
                </div>
            </div>
        </div>
    @endif
