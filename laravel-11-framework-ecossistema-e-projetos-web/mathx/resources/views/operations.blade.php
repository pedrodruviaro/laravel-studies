...
<body>
    <div class="text-center my-3">
        <img src="{{ asset('assets/images/logo.jpg') }}" alt="logo" class="img-fluid" width="250">
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col text-end">
                <a href="{{ route('export_exercises') }}" class="btn btn-secondary px-5">DESCARREGAR EXERCÍCIOS</a>
                <a href="{{ route('print_exercises') }}" class="btn btn-secondary px-5">IMPRIMIR EXERCÍCIOS</a>
            </div>
        </div>
    </div>
